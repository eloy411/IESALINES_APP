  ...
  actions: {
    ...
    async getCategoriasPorcentaje() {
      try {
        ...
        const res = await api.get("http://localhost:8001/api/admin/ronda/subcat-porcentajes");
    ...
    async deleteSubCategoriesVotaciones(rowToDelete){
      try {
        ...
        const res = await api.delete(`http://localhost:8001/api/admin/ronda/subcat-votaciones/${rowToDelete.id_subcategoria}`)
        console.log(res);
    ...
    async getSubCategoriasIndependent(){
      try {
        ...
        const res = await api.get('http://localhost:8001/api/admin/subcategorias');
        console.log(res);
    ...
    async getSubCategoriasAuxFromSelect(tipoJurado){
      try {
        ...
        const res = await api.get(`http://localhost:8001/api/admin/aux-subcategorias/${tipoJurado}`);
        console.log(res);
        console.log(this.subCategoriasArrAux);
    ...
    async putSubCategoriasAux(tipoJurado, idEdicion){
      try {
        ...
        console.log(idArr);
        const res = await api.put(`http://localhost:8001/api/admin/aux-subcategorias`, {
    ...
    async getSubCategoriasFromResult() {
      try {
        ...
        const res = await api.get(`http://localhost:8001/api/admin/ronda/subcat-result`);
        console.log(res);
    ...
    ////////////////////////////////////////////////////////////////////////////
     ...
     async getVotosJuradoResult () {
      try {
        ...
        const res = await api.get(`http://localhost:8001/api/admin/ronda/jurados-result/${this.id_subcategoria}`, {
